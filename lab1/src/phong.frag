...
void main(void)
{
	const vec3 light = normalize(vec3(0.58, 0.58, 0.58)); // Given in VIEW coordinates! You usually specify light sources in world coordinates.
	...
	shade = 1.0*diffuse + 13.0*specular;
